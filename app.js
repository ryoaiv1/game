...
const cancelChangeNameBtn = $("cancelChangeNameBtn");
...
if(cancelChangeNameBtn){
  cancelChangeNameBtn.onclick = closeChangeNameModal;
}
...
document.addEventListener("keydown", (e)=>{
  if(e.key === "Escape") closeChangeNameModal();
});
...
if(confirmChangeNameBtn){
  confirmChangeNameBtn.onclick = async ()=>{
    ...
    // لو جوه غرفة: حدّث الاسم في Firebase
